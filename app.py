...
def index():
    ...
    # Fixed XSS vulnerability by escaping user input and rendering query to template
    return render_template('index.html', products=products, query=html.escape(query))
